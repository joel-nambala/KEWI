    ...
    public class OpenTendersController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                ...
                string openTenders = webportals.GetOpenTenders(vendorNo);
        ...
        public ActionResult SubmitTenderApplication(Tender tender)
        {
            ...
            try
            {
                ...
                string bidNo = webportals.CreateRFQHeader(vendorNo, tenderNo);
                if (!string.IsNullOrEmpty(bidNo))
                {
                    ...
                    foreach (string category in categoriesArr)
                    {
                        ...
                        decimal quantity = Convert.ToDecimal(responseArr[1]);
                        webportals.InsertRFQLines(vendorNo, tenderNo, bidNo, itemNo, quantity,entryNo);
                    }
                    webportals.SubmitRFQ(vendorNo, bidNo);
                    ...
                    if (tender.RFQForm != null && tender.RFQForm.ContentLength > 0)
                    {
                        ...
                        webportals.DocumentAttachment(bidNo, filename, base64String, 38);
                    }
        ...
        public ActionResult BidLines(string bidNo)
        {
            ...
            {
                string vendorNo = Session["VendorNo"].ToString();
                var list = GetBidLines(vendorNo, bidNo);
        ...
        private List<Tender> GetMyQuotes()
        {
            ...
            {
                string vendorNo = Session["VendorNo"].ToString();
                string quotes = webportals.GetMyQuotes(vendorNo);
        ...
        private List<Tender> GetBidLines(string vendorNo, string bidNo)
        {
            ...
            try
            {
                string bidLines = webportals.GetMyQuoteLines(vendorNo, bidNo);
